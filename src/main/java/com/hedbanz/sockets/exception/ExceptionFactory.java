...
import com.hedbanz.sockets.error.*;
...
public class ExceptionFactory {
    ...
    public static ApiException create(final Throwable cause, final ApiError error, final Object... messageArguments) {
        LOG.error(MessageFormat.format(error.getErrorMessage(), messageArguments), cause);
        return new ApiException (error, cause, messageArguments);
    }

    public static ApiException create(final ApiError error, final Object... messageArguments) {
        LOG.error(MessageFormat.format(error.getErrorMessage(), messageArguments));
        return new ApiException(error, messageArguments);
    }
}
