...
public class SocketEvents {
    ...
    public static final String SERVER_ADVERTISE = "server-advertise";
    public static final String SERVER_WAITING_FOR_USERS = "server-waiting-for-users";
    public static final String SERVER_UPDATE_USERS_INFO = "server-update-users-info";
